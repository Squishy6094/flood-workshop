...
local function flood_load_star_road_levels()
    ...
    --                 bonus  level                 name              goal position                                     speed area type         custom start pos
    flood_define_level(false, LEVEL_BOB,            "boi",            { x =  5364, y = 1875,  z =  2251, a =  0x0000 }, 3.0,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_WF,             "slr",             { x =  208,  y = 2448,  z = -2080, a =  0x4000 }, 5.0,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_JRB,            "ppp",            { x = -4672, y = 3541,  z = -3619, a = -0x4000 }, 4.0,  1,   FLOOD_WATER, { x = 2316, y = -448, z = -5150, a = 0x0000 })
    flood_define_level(false, LEVEL_CCM,            "ch",            { x =  5709, y = 3501,  z = -2141, a = -0x4000 }, 3.0,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_PSS,            "mmt",            { x = -3415, y = 4573,  z =  2678, a =  0x0000 }, 3.0,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_BITDW,          "bss",          { x =  455,  y = 2324,  z =  0,    a = -0x4000 }, 3.0,  1,   FLOOD_MUD,   nil)
    flood_define_level(false, LEVEL_BBH,            "gg",            { x =  4376, y = 2632,  z = -4542, a =  0x0000 }, 3.0,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_LLL,            "kc",            { x =  4348, y = 4638,  z =  3877, a = -0x4000 }, 7.0,  1,   FLOOD_SAND,  nil)
    flood_define_level(false, LEVEL_SL,             "msp",             { x =  4543, y = 3709,  z =  3311, a =  0x8000 }, 2.5,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_WDW,            "ccc",            { x = -3342, y = 2603,  z =  845,  a =  0x4000 }, 4.0,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_TTM,            "cs",            { x =  1033, y = 4813,  z = -6320, a =  0x8000 }, 2.0,  1,   FLOOD_WATER, nil)
    flood_define_level(false, LEVEL_TTC,            "bobf",            { x =  1405, y = 3425,  z = -3463, a =  0x8000 }, 4.0,  1,   FLOOD_LAVA,  nil)
    flood_define_level(false, LEVEL_RR,             "sr",             { x =  5052, y = 11056, z =  413,  a = -0x4000 }, 4.0,  1,   FLOOD_WATER, { x = 3923, y = -3283, z = -1323, a = 0x8000 })
